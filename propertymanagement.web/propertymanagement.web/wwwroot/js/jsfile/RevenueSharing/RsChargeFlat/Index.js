...
$(document).ready(function () {
    getAjaxDataPM("", "rs_rent_charge_table_header", "RsChargeFlat/GetDataAll?type=flat", AddNew);

    function AddNew() {
        window.location.href = '/Marketing/RevenueSharing/RsCharge/RsChargeFlat/Create';
    }
    ...
    function applyFilter(e) {
        ...
        getAjaxDataPM(data, "rs_rent_charge_table_header", "RsChargeFlat/GetDataAll?type=flat", AddNew);
    }
...
function rs_rent_charge_table_header_editor_view(e) {
    window.location.href = "/Marketing/RevenueSharing/RsCharge/RsChargeFlat/Details?Id=" + $(e).data('id');
}

function rs_rent_charge_table_header_editor_edit(e) {
    window.location.href = "/Marketing/RevenueSharing/RsCharge/RsChargeFlat/Edit?Id=" + $(e).data('id');
}
...
function rs_rent_charge_table_header_editor_remove(e) {
    ...
    Swal.fire({
        ...
        if (ok.value) {
            $.ajax({
                url: '/Marketing/RevenueSharing/RsCharge/RsChargeFlat/OnDelete',
                type: 'PUT',
                data: param,
                dataType: 'json',
