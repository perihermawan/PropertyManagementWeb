$(document).ready(function () {
    getAjaxDataMF("", "mf_table_header", "MF/GetDataAll", AddNew);

    function AddNew() {
        window.location.href = '/Marketing/MF/Create';
    }
...
var table = document.getElementById("mf_table_header");

function mf_table_header_editor_view(e) {
    var rowId = table.rows[e.parentNode.parentNode.rowIndex].cells[1].innerText;
    var code = $(e).closest('tr').children('.sourceCode').text();
    window.location.href = "/Marketing/Mf/Details?Id=" + rowId + "&code=" + code;
}

function mf_table_header_editor_edit(e) {
    var rowId = $(e).closest('tr').children('.hidden').text();
    var code = $(e).closest('tr').children('.sourceCode').text();
    window.location.href = "/Marketing/Mf/Edit?Id=" + rowId + "&code=" + code;
}

function mf_table_header_editor_remove(e) {
    var rowId = table.rows[e.parentNode.parentNode.rowIndex].cells[1].innerText;
