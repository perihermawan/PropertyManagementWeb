$(function() {
    $("#date_of_work").on("change", function(){
        // $("#select2_employee").empty().trigger("change");
        var date_of_work = $(this).val();
       
        $.ajax({
            url: "transactions/general_worker_assignment/find_employee",
            type:'GET',
            data: {date_of_work: date_of_work},
            dataType: 'json',
            success:function(response){
                if (response.status == "OK") {
                    ...
                    // $("#select2_employee").val(response.data["attendance_employee_code"]).trigger("change");
                }
                else{
    ...
    //     $.ajax({
    //         url: "transactions/general_worker_assignment/get_blocks/",
    //         type:'GET',
    ...
    function change_form_editable(activity_code , division_code, block_code) {  
        ...
        $("#hektar_err_text").hide();
        $.ajax({
            url: "transactions/general_worker_assignment/get_activity_details/",
            type:'GET',
    ...
    $("select[name='workplan_block_code']").on("change", function(){
        $("#block_hectarage").val("");
        $.ajax({
            url: "transactions/general_worker_assignment/get_block_information/",
            type:'GET',
            dataType: 'json',
